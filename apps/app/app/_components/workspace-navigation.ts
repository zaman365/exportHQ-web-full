...
export type WorkspaceDestination = "dashboard" | "attention" | "inbox" | "work" | "blueprints" | "waiting" | "decisions" | "ideas" | "team" | "create" | "learning" | "settings" | "markets" | "opportunities" | "studio" | "readiness" | "other";
...
export const workspaceGroups = [
  ...
  { label: "MANAGE", items: [["Export readiness", Gauge, "/readiness", "readiness", "readiness"], ["Requirements", ShieldCheck, "/#requirements", "other", "requirements"], ["Learning Center", BookOpenCheck, "/learn", "learning", "learning"], ["Settings", Settings, "/settings", "settings", "settings"]] }

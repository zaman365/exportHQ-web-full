  ...
  return (
    <details className="mobile-navigation" ref={detailsRef}>
      ...
      <div className="mobile-navigation__panel">
        ...
        <Link href="/learn" className="mobile-navigation__learn" onClick={close}><BookOpenCheck size={17} /><span><strong>Need help?</strong><small>Open the ExportPanel Learning Center</small></span><ArrowRight size={15} /></Link>
      </div>
    </details>
  );
}

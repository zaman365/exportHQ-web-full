  ...
  return (
    <div className="explore-home">
      <section className="workspace-page-head explore-home__head">
        <span><p>HOME / STARTING POINT</p><h1>Welcome to ExportPanel, {session.userName?.split(" ")[0] ?? "there"}.</h1><small>Your business brief is set up. Run the readiness assessment now; verify the business or choose a paid plan when you need the complete solution layer.</small></span>
      ...
      <section className="explore-grid">
        <article><span><BookOpenCheck size={20} /></span><p>AVAILABLE NOW</p><h2>Learn how ExportPanel works</h2><small>Use the complete Learning Center to understand scores, evidence, workflows, and roles before subscribing.</small><Link href="/learn">Open Learning Center <ArrowRight size={14} /></Link></article>

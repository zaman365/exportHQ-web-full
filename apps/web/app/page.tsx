...
import { Atlas, OrbitDiagram } from "./_components/atlas";
  ...
  return (
    <>
      ...
      <main id="main">
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <p className="hero-lead">
                Managed by export specialists, powered by one workspace that connects readiness, requirements, buyers and trade
                execution—for any business ready to grow abroad.
              </p>
              <div className="hero-actions">
                <a className="btn btn-signal btn-lg" href="#brief">
                  Start your export brief <ArrowRight size={17} strokeWidth={2.2} />
                </a>
              ...
              <ul className="hero-proof">
                <li>
                  <Check size={14} strokeWidth={2.6} /> Products, services and expertise
                </li>
                <li>
                  <Check size={14} strokeWidth={2.6} /> First market to multi-market scale
                </li>
                <li>
                  <Check size={14} strokeWidth={2.6} /> Platform and human execution
                </li>
              </ul>
            </div>

            <div className="hero-visual">
              <span className="hero-chip chip-market">Market → Plan</span>
              <span className="hero-chip chip-action">Action → Owner</span>
              <Console />
            </div>
          </div>
        ...
        <section className="section brief" id="brief">
          <div className="container brief-grid">
            <div className="brief-copy" data-reveal>
              ...
              <h2 className="h-display">Tell us what you want to take abroad.</h2>
              <p className="lead">
                Share the basics and continue into your private workspace. Export HQ will use your context to shape the next
                questions—not drop you into a generic sales funnel.
              </p>
              <ul className="tick-list">
                <li>
                  <Check size={15} strokeWidth={2.6} /> Start with a product, service or capability
                </li>
                <li>
                  <Check size={15} strokeWidth={2.6} /> Name a market—or ask us to help choose one
                </li>
                <li>
                  <Check size={15} strokeWidth={2.6} /> Get a structured readiness path
                </li>
              </ul>
            </div>

            <form className="brief-form" action={`${appUrl}/onboarding`} method="get" data-reveal>
              <span className="form-tab">Export brief</span>
              <label className="field">
                <span>What does your business provide?</span>
                <input name="offering" placeholder="Products, services or specialist expertise" required />
              </label>
              <div className="field-pair">
                ...
                <label className="field">
                  ...
                  <input name="market" placeholder="Country, region or help me choose" />
                </label>
              </div>
              <button className="btn btn-ink btn-lg btn-block" type="submit">
                Show me the next steps <ArrowRight size={17} strokeWidth={2.2} />
              </button>
              <p className="form-note">No generic report. Your answers shape a company-specific starting point.</p>
            </form>
          </div>
        </section>
          ...
          <div className="container">
            <div className="section-head" data-reveal>
              ...
              <p className="section-note">
                Most export work breaks in the gaps between strategy, compliance, sales and delivery. Export HQ keeps the output of
                each stage connected to the next.
              </p>
            </div>

            <div className="stage-grid" data-reveal>
              {operatingStages.map(({ number, icon: Icon, title, text, outputs }, index) => (
                <article
                  className="stage-card"
                  key={title}
                  style={{ "--progress": `${((index + 1) / operatingStages.length) * 100}%` } as React.CSSProperties}
                >
                  <header>
          ...
          <div className="container editorial-grid">
            ...
            <div data-reveal>
              ...
              <p className="lead lead-inv">
                Markets are entered through decisions made by people—your team, buyers, specialists and delivery partners. Export HQ
                gives those people one operating picture, so you can see what was decided, why it matters and who moves it next.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section managed" id="managed">
          <div className="container managed-grid">
            <div data-reveal>
              ...
              <h2 className="h-section">One team from first question to delivered trade.</h2>
              <p className="lead">
                You do not have to stitch together a market consultant, compliance researcher, buyer list, spreadsheet and freight
                thread. Export HQ coordinates the work through the same platform your company sees.
              </p>
              <ul className="point-list">
                <li>
                  ...
                  <span>
                    ...
                    <small>Markets, requirements and buyers tied to your actual offer.</small>
                  </span>
                </li>
                <li>
                  ...
                  <span>
                    ...
                    <small>Your team, Export HQ and external specialists each have visible actions.</small>
                  </span>
                </li>
                <li>
                  ...
                  <span>
                    ...
                    <small>Experts review important decisions and regulated requirements.</small>
                  </span>
                </li>
                <li>
                  ...
                  <span>
                    ...
                    <small>Activity stays connected to costs, opportunities and outcomes.</small>
                  </span>
                </li>
              </ul>
              <a className="text-link" href="#process">
                See how the work moves <ArrowRight size={16} strokeWidth={2.2} />
              </a>
            </div>
        ...
        <section className="section coverage" id="capabilities" aria-labelledby="coverage-title">
          <div className="container">
            <div className="section-head" data-reveal>
              <div>
              ...
              <p className="section-note">
                Start with readiness. Add only what your business needs. Keep every step connected as your export operation matures.
              </p>
            </div>

            <div className="coverage-grid" data-reveal>
              {capabilityCoverage.map(({ number, icon: Icon, title, text, href }) => (
                <a className="coverage-card" key={title} href={href} aria-label={`Learn more about ${title}`}>
                  <header>
                    <span className="card-index">{number}</span>
                    <span className="card-icon">
        ...
        <section className="section process" id="process">
          <div className="container">
            <div className="section-head" data-reveal>
              ...
              <p className="section-note">Select a stage to see what happens, how Export HQ supports it and what your company receives.</p>
            </div>
        ...
        <section className="section industries" id="industries">
          <div className="container">
            <div className="section-head" data-reveal>
              ...
              <p className="section-note">
                Export HQ adapts to the offer, evidence, buying process and delivery model of your business—across industries and
                company sizes.
              </p>
            </div>
          ...
          <div className="container">
            <div className="section-head section-head-stack" data-reveal>
              <div>
                ...
                <h2 className="h-section">Export HQ meets your operation where it is.</h2>
              </div>
            </div>
          ...
          <div className="container trust-grid">
            <div data-reveal>
              ...
              <h2 className="h-section h-section-inv">
                Your international business is confidential. Your export decisions should be explainable.
              </h2>
            </div>
            <ul className="trust-points" data-reveal>
              <li>
                ...
                <span>
                  ...
                  <small>Organization-based access and private business documents.</small>
                </span>
              </li>
              <li>
                ...
                <span>
                  ...
                  <small>Sources, dates and human review for requirements.</small>
                </span>
              </li>
              <li>
                ...
                <span>
                  ...
                  <small>Structured for portability and future integrations.</small>
                </span>
              </li>
              <li>
                <Handshake size={20} strokeWidth={1.7} />
                <span>
                  ...
                  <small>Staff and partner access is explicit and scoped.</small>
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="section questions">
          <div className="container questions-grid">
            <div className="questions-intro">
              ...
              <h2 className="h-section">Clear answers to the important questions.</h2>
              <p className="lead">
                Export HQ is designed to make international growth easier to understand before asking you to commit.
              </p>
            </div>
        ...
        <section className="section final-cta has-grain">
          ...
          <div className="container cta-inner">
            <div data-reveal>
              ...
              <h2 className="h-display">Tell us what you want to take abroad.</h2>
              <p className="lead lead-inv">
                We will help you understand what is possible, what it requires and what should happen next.
              </p>
            </div>
            <div className="cta-actions" data-reveal>
              ...
              <a className="text-link text-link-inv" href="mailto:hello@exporthq.com">

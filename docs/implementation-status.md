...
| -------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Gate 0 — ownership and freeze    | In progress | Protected `main`, 8 required checks, 6 milestones and the 22-item R0/R1 backlog exist; Mohammed Maniruzzaman owns all six single-founder roles, while independent review and policy approvals remain absent        |
